...
const API_URL =
  'https://distribuidoraassefperico.com.ar/apis-stg/localidades.php'
...
const LocalidadesTable = () => {
  ...
  const handleSave = async (e) => {
    ...
    const url = selectedLocalidad.id
      ? `${API_URL}?id=${selectedLocalidad.id}`
      : API_URL
                ...
                <form onSubmit={handleSave}>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      type="number"
                      className="form-control"
                      value={selectedLocalidad.precio_envio}
                      onChange={(e) =>
                        setSelectedLocalidad({
                          ...selectedLocalidad,
                          precio_envio: e.target.value,
                        })
                      }
                      required
                    />
                  ...
                  <button type="submit" className="btn btn-primary">
                    {selectedLocalidad.id ? 'Actualizar' : 'Guardar'}
                  </button>
                  <button
                    type="button"
                    className="btn btn-secondary ms-2"
