...
const ProductTable = () => {
  ...
  const API_CATEGORIA =
    process.env.REACT_APP_API + 'categorias.php?endpoint=categoria' //agregue para buscar categoria
  const API_SUBCATEGORIA =
    process.env.REACT_APP_API + 'subcategorias.php?endpoint=subcategoria'
  const API_PROVEEDOR =
    process.env.REACT_APP_API + 'proveedor.php?endpoint=proveedor'
  ...
  const filtroSubcategoria = (idcat) => {
    ...
    const subcategoriasFiltradas = subcategoria.filter(
      (sub) => sub.idcategoria === idcategoriaNum
    )
                ...
                {category.estado === 'Duplicado' ? (
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '25px',
                      backgroundColor:
                        category.estado === 'Activo' ? '#4CAF50' : '#ccc',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent:
                      ...
                      >
                        <textarea
                          ...
                          onChange={(e) =>
                            setSelectedCategory({
                              ...selectedCategory,
                              descripcioncompleta: e.target.value,
                            })
                          }
