...
const Comercio = () => {
  ...
  const handleEdit = (comercio) => {
    setFormData({ ...comercio, imagenes: JSON.parse(comercio.imagenes || "[]") });
    setModalOpen(true);
  };
            ...
            <tr key={comercio.id}>
              ...
              <td>
                {JSON.parse(comercio.imagenes || "[]").map((img, index) => (
                  <img key={index} src={base+img} alt="Comercio" className="img-thumbnail" style={{ width: "50px" }} />
                ))}
              </td>
              <td>
                <button className="btn btn-primary" onClick={() => handleEdit(comercio)}>
                  Editar
                </button>
              </td>
            </tr>
              ...
              <div className="modal-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input className="form-control-file" type="file" multiple onChange={handleFileChange} />
                    <div className="mt-2">
