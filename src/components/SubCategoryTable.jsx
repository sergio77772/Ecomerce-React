...
const SubCategoryTable = () => {
  ...
  const API_CATEGORIA =
    process.env.REACT_APP_API + 'categorias.php?endpoint=categoria'
    ...
    try {
      if (imageFile) {
        ...
        const uploadResponse = await fetch(
          `${process.env.REACT_APP_API}subcategorias.php?endpoint=upload`,
          {
            method: 'POST',
            body: formData,
          }
              ...
              <td>
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    justifyContent:
                      Category.estado === 'Activo' ? 'flex-end' : 'flex-start',
                    padding: '3px',
                    cursor: 'pointer',
