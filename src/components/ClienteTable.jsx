    ...
    try {
      if (imageFile) {
        ...
        const uploadResponse = await fetch(
          `${process.env.REACT_APP_API}cliente.php?endpoint=upload`,
          {
            method: 'POST',
            body: formData,
          }
      ...
      if (!response.ok) {
        throw new Error(
          isEditing
            ? 'Error al actualizar la Cliente.'
            : 'Error al crear la Cliente.'
        )
      }
            ...
            <form onSubmit={handleSave}>
              <div className="modal-body">
                ...
                <div className="row">
                  ...
                  <div className="col-md-4">
                    <label>
                      <strong>Limite de la Cta Cte</strong>
                    </label>
                    <div
                      className="mb-3"
                      style={{
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          setSelectedClie({
                            ...selectedClie,
                            limitecuentacorriente: e.target.value,
                          })
                        }
                      />
                    </div>
                  ...
                  >
                    {selectedClie.foto && (
                      <div className="mb-2">
                        <img
                          src={
                            process.env.REACT_APP_BASE_URL + selectedClie.foto
                          }
                          alt="Vista previa"
                          style={{
                            width: '100px',
