    ...
    try {
      if (imageFile) {
        ...
        const uploadResponse = await fetch(
          `${process.env.REACT_APP_API}venta.php?endpoint=upload`,
          {
            method: 'POST',
            body: formData,
          }
      ...
      const endpoint = isEditing ? `${API}&id=${selectedVen.idventa}` : `${API}`
                  ...
                  >
                    {selectedVen.imagen && (
                      <div className="mb-2">
                        <img
                          src={
                            process.env.REACT_APP_BASE_URL + selectedVen.imagen
                          }
                          alt="Vista previa"
                          style={{
                            width: '100px',
