...
const Checkout = () => {
  ...
  const ShowCheckout = () => {
    let subtotal = state.reduce(
      (acc, item) => acc + item.precioventa * item.qty,
      0
    )
    let shipping = 30.0
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        <i className="fa fa-phone me-2"></i> Quiero que me
                        contacten
                      </>
                    )}
                  </button>
                  ...
                  <button
                    className="w-100 btn btn-secondary d-flex align-items-center justify-content-center mt-3"
                    disabled
                  >
                    <i className="fa fa-credit-card me-2"></i> Pagar con
                    MercadoPago
                  </button>
                </form>
              </div>
